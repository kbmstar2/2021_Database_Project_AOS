...
-- Dump completed on 2021-12-13  5:59:52
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
...
INSERT INTO `enemystatus` VALUES (1,'Teemo',500,334,54,24,0),(2,'Graves',555,325,68,33,0),(3,'Ryze',575,300,58,22,0),(4,'Vayne',515,232,60,23,0),(5,'Galio',562,500,59,24,0);
...
LOCK TABLES `item` WRITE;
/*!40000 ALTER TABLE `item` DISABLE KEYS */;
INSERT INTO `item` VALUES (3002,'Muramana',0,860,35,NULL,0);
/*!40000 ALTER TABLE `item` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `playerstatus` VALUES (1,'Ezreal',530,1235,95,24,3800);
